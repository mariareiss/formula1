...
<div class="modal fade" id="editDriverModal<?php echo $driver['driver_id']; ?>" tabindex="-1" aria-labelledby="editDriverModallabel<?php echo $driver['driver_id']; ?>" aria-hidden="true">
  ...
  <div class="mb-3">
    <label for="dNationality<?php echo $driver['driver_id']; ?>" class="form-label">Driver Nationality</label>
    <input type="text" class="form-control" id="dNationality<?php echo $driver['driver_id']; ?>" name="dNationality" value="<?php echo $driver['driver_nationality']; ?>">
  </div>
  <div class="mb-3">
    <label for="dAge<?php echo $driver['driver_id']; ?>" class="form-label">Driver Age</label>
